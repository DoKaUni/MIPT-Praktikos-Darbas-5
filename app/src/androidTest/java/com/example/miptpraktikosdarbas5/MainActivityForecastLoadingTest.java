...
public class MainActivityForecastLoadingTest {
    ...
    @Test
    public void mainActivityForecastLoadingTest() {
        ...
        ViewInteraction textView = onView(
                allOf(withId(android.R.id.text1), withText("Location name: Kaunas, latitude: 54.898214, longitude: 23.904482 "),
