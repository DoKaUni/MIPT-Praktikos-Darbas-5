...
public class MainActivityFloatRatesLoadingTest {
    ...
    @Test
    public void mainActivityFloatRateLoadingTest() {
        ...
        ViewInteraction textView = onView(
                allOf(withId(android.R.id.text1), withText("Currency name: Euro, code: EUR, rate: 0.91482735"),
